"""Add user vehicle plate

Revision ID: d1a81eb5cbbd
Revises: 9b0428465e3d
Create Date: 2025-11-19 23:48:41.257345
...
revision: str = 'd1a81eb5cbbd'
down_revision: Union[str, Sequence[str], None] = '9b0428465e3d'
...
def upgrade() -> None:
    ...
    op.add_column('payoutaccount', sa.Column('is_active', sa.Boolean(), nullable=False))
    op.add_column('user', sa.Column('default_vehicle_plate', sqlmodel.sql.sqltypes.AutoString(length=20), nullable=True))
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('user', 'default_vehicle_plate')
    op.drop_column('payoutaccount', 'is_active')
