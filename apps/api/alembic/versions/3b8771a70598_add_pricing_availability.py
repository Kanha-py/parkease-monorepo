"""add_pricing_availability

Revision ID: 3b8771a70598
Revises: acc7f50e2282
Create Date: 2025-11-18 16:53:55.131096
...
revision: str = '3b8771a70598'
down_revision: Union[str, Sequence[str], None] = 'acc7f50e2282'
...
def upgrade() -> None:
    ...
    sa.Column('rate_type', sqlmodel.sql.sqltypes.AutoString(length=20), nullable=False),
    sa.Column('is_active', sa.Boolean(), nullable=False),
    sa.Column('priority', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['lot_id'], ['parkinglot.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_pricingrule_lot_id'), 'pricingrule', ['lot_id'], unique=False)
    op.create_table('spotavailability',
    ...
    sa.ForeignKeyConstraint(['spot_id'], ['parkingspot.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_spotavailability_end_time'), 'spotavailability', ['end_time'], unique=False)
    op.create_index(op.f('ix_spotavailability_spot_id'), 'spotavailability', ['spot_id'], unique=False)
    op.create_index(op.f('ix_spotavailability_start_time'), 'spotavailability', ['start_time'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_spotavailability_start_time'), table_name='spotavailability')
    op.drop_index(op.f('ix_spotavailability_spot_id'), table_name='spotavailability')
    op.drop_index(op.f('ix_spotavailability_end_time'), table_name='spotavailability')
    op.drop_table('spotavailability')
    op.drop_index(op.f('ix_pricingrule_lot_id'), table_name='pricingrule')
