"""add_inventory_tables_v2

Revision ID: acc7f50e2282
Revises: cd5c6e0d2ef7
Create Date: 2025-11-18 16:09:54.424959
...
revision: str = 'acc7f50e2282'
down_revision: Union[str, Sequence[str], None] = 'cd5c6e0d2ef7'
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('lot_id', 'amenity_id')
    )
    op.create_table('parkingspot',
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('lot_id', sa.Uuid(), nullable=False),
    sa.Column('name', sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False),
    sa.Column('spot_type', sqlmodel.sql.sqltypes.AutoString(length=20), nullable=False),
    sa.ForeignKeyConstraint(['lot_id'], ['parkinglot.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade() -> None:
    ...
    op.drop_table('parkingspot')
    op.drop_table('lotamenity')
    op.drop_index('idx_parkinglot_location', table_name='parkinglot', postgresql_using='gist')
