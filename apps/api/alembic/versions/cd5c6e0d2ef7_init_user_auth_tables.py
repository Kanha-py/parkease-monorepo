...
Revision ID: cd5c6e0d2ef7
Revises:
Create Date: 2025-11-18 15:14:30.571355
...
def upgrade() -> None:
    ...
    sa.Column('account_details_encrypted', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
