"""add_booking_payment_tables

Revision ID: 9b0428465e3d
Revises: 3b8771a70598
Create Date: 2025-11-18 20:55:01.655213
...
revision: str = '9b0428465e3d'
down_revision: Union[str, Sequence[str], None] = '3b8771a70598'
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['driver_user_id'], ['user.id'], ),
